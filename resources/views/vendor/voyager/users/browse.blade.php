                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            @endforeach
                                            @if($data->is_block == 0)
                                                <a href="javascript:;" id="{{$data->id}}" class="btn btn-sm btn-warning view block-class pull-right mr-3" title="Block" style="background-color: #fa2a00;">
                                                    <!-- <i class="glyphicon glyphicon-ban-circle"></i> -->
                                                    <i class="fa fa-lock"></i>
                                                </a>
                                            @else
                                                <a href="javascript:;" id="{{$data->id}}" class="btn btn-sm btn-warning view unblock pull-right mr-3" title="Unblock" style="background-color: #43d17f;">
                                                    <!-- <i class="glyphicon glyphicon-unlock"></i> -->
                                                    <i class="fa fa-unlock" aria-hidden="true"></i>
                                                </a>
                                            @endif  
                                            @if($data->is_active == 0)
                                                <a href="javascript:;" id="{{$data->id}}" class="btn btn-sm btn-warning  activate pull-right mr-3" title="Activate" style="background-color: #43d17f;">
                                                    <i class="glyphicon glyphicon-ok" ></i>
                                                </a>
                                            @else
                                                <a href="javascript:;" id="{{$data->id}}" class="btn btn-sm btn-warning  deactivate pull-right mr-3" title="Deactivate" style="background-color: #fa2a00;">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.activate').on('click', function () {
                var url = '{{ route("users.changeActivationStatus") }}';
                $('#change_status_form')[0].action = url;
                $('#chngstatus_userid').val($(this).attr('id'));
                $('#status').val('1');
                $('#modal-title').html('Are you sure want to Activate this user?');
                $('.change-confirm').val('Yes, Activate!');
            ...
            $('.deactivate').on('click', function () {
                ...
                $('#chngstatus_userid').val($(this).attr('id'));
                $('#status').val('0');
                $('#modal-title').html('Are you sure want to Deactivate this user?');
                $('.change-confirm').val('Yes, Deactivate!');
                $('#change_status_modal').modal('show');
            });
