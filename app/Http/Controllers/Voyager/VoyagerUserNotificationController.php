...
class VoyagerUserNotificationController extends VoyagerBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        //Review::where('id', '!=' , '')->update(['showby_admin' => '1']);
        ...
        if (strlen($dataType->model_name) != 0) {
            ...
            $query->orderBy("Showby_admin", "ASC");
        ...
        $dataTypeContent = $dataTypeContent->where("ratingFor","!=","customer");
    ...
    public function update(Request $request, $id)
    {
        ...
        ->with([
            'message'    => __('voyager::generic.successfully_updated'.Session('dlang').'')." {$dataType->display_name_singular}",
            'alert-type' => 'success',
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        ->route("voyager.{$dataType->slug}.index")
        ->with([
                'message'    => __('voyager::generic.successfully_added_new'.Session('dlang').'')." {$dataType->display_name_singular}",
                'alert-type' => 'success',
            ]);
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        $data = $res
            ? [
                'message'    => __('voyager::generic.successfully_deleted'.Session('dlang').'')." {$displayName}",
                'alert-type' => 'success',
            ]
            : [
    ...
    public function restore(Request $request, $id)
    {
        ...
        $data = $res
            ? [
                'message'    => __('voyager::generic.successfully_restored'.Session('dlang').'')." {$displayName}",
                'alert-type' => 'success',
            ]
            : [
    ...
    public function updateReviewFlag(Request $request){
       //echo "<pre>";print_r($request->bookingId);exit;
  //      DB::enableQueryLog();
       $data = Review::where('booking_id',$request->bookingId)->first();
       $data->showby_admin = 1;
       $data->save();
